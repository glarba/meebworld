...
public class Generate {
    ...
    public static final int genTime = 300;
    ...
    public static void GenerateLandSquare(int x) throws Exception {
    ...
    public static void GenerateBeach() throws Exception {
    ...
    public static void IslandDelete() throws Exception {
        for (int i = 0; i < world.length; i++) {
            for (int j = 0; j < world[0].length; j++) {
    ...
    public static void GenerateDepth() throws Exception {
    ...
    public static void AddTrees() {
        for (int i = 0; i < world.length; i++) {
            for (int j = 0; j < world[0].length; j++) {
                if (world[i][j][0].equals(GRASS) && random.nextInt(33) == 0) {
                    world[i][j][1] = TREE;
                }
            }
        }
    ...
    public static void MapPrint() throws Exception {
